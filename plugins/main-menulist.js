...
const sections = [
   {
    ...
    rows: [
       ...
       {title: `⏲️ ${pmenus} SUBSCRIBE YT`, rowId: ".zyko-md", description: "Jangan Lupa Subscribe yt skyzoNation"},
        ]
        },
]
...
conn.send3ButtonVid(m.chat, 'https://telegra.ph/file/b1db1904e2128ffbdaa63.png', `${namebot}`, floor + text.trim() + `\n` + botdate, 'Menu', '.menu', 'Owner', '.owner', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://www.instagram.com/rnxzbot',
    mediaType: 2, 
    description: sgc,
    title: "R N X Z M U L T I D E V I C E",
    body: bottime,
    thumbnail: await (await fetch(pp)).buffer(),
    sourceUrl: sig
