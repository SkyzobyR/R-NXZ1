...
let handler = async (m, { conn, generateWAMessageFromContent, }) => {
    ...
    const fgclink = {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6281341554776-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Halo", 
                   "caption": wm, 
...
conn.sendButtonDoc(m.chat, '▷ʙᴏᴛ sᴛᴀᴛᴜs◁', sts, 'Owner', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https//wa.me/6281341554776?text=Hᴀʟᴏ',
    mediaType: 2, 
    description: 'wa.me/6281341554776?text=Hᴀʟᴏ+ɢᴀɴᴛᴇɴɢᴋᴜ',
    title: "Ini instagram saya",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://instagram.com/rnxzbot'
     }}
  })
