...
let zyko = `*『 𝙍-𝙉𝙓𝙕 𝙈𝙐𝙇𝙏𝙄𝘿𝙀𝙑𝙄𝘾𝙀 』*`
conn.send3ButtonImg(m.chat, `https://telegra.ph/file/b1db1904e2128ffbdaa63.png`, zyko, kabul, 'All Menu', '.? all', 'List Menu', '.tesm', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
